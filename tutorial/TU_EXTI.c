...
int main(void) {
	...
	RCC->APB2ENR |= RCC_APB2ENR_SYSCFGEN;     // 1 << 14 --> mask


	//EXTICR[0] = EXTICR1 : 0 ~ 3  
	//EXTICR[1] = EXTICR2 : 4 ~ 7  
	//EXTICR[2] = EXTICR3 : 8 ~ 11  
	//EXTICR[3] = EXTICR4 : 12 ~ 15 
	
	// Connect External Line to the GPIO
	SYSCFG->EXTICR[BUTTON_PIN/4] &= ~SYSCFG_EXTICR4_EXTI13;     
	// Button: PC_13 -> EXTICR4(EXTI13)
